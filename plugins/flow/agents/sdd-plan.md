...
The plan's Constitution / Quality Gates section must include the architectural rules `ARCH-1` through `ARCH-10` (canonical source: `ccc/skills/arch-check/SKILL.md`) and reference `flow/skills/arch-review` for review-time evaluation. Do not restate the rule semantics in the plan; cite them.
