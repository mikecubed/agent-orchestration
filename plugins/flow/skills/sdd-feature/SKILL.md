...
2. Ask: "Would you like to start with a feature specification? Running `/flow:sdd-specify` will create a structured spec with user stories and requirements. Or I can proceed directly."
3. If the user agrees: run `/flow:sdd-specify` and use their feature description
