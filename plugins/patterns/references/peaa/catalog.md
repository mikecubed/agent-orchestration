# PEAA Pattern Catalog

**Source**: *Patterns of Enterprise Application Architecture* — Martin Fowler et al. (Addison-Wesley, 2002)
**Primary language**: Python (C# and Rust as stretch goals)

> **Anti-hallucination policy**: Every Intent statement is quoted or closely paraphrased from
> the book with a page citation. Python examples are adapted from the book's Java/C# examples
> and note the source page. Anything not directly from the book is marked `[interpretation]`.
> Page numbers refer to book pages (PDF page ≈ book page − 25).
...
- [Transaction Script](#transaction-script) — p. 110
- [Domain Model](#domain-model) — p. 116
- [Table Module](#table-module) — p. 125
- [Service Layer](#service-layer) — p. 133

### Chapter 10 — Data Source Architectural Patterns
- [Table Data Gateway](#table-data-gateway) — p. 144
- [Row Data Gateway](#row-data-gateway) — p. 152
- [Active Record](#active-record) — p. 160
- [Data Mapper](#data-mapper) — p. 165

### Chapter 11 — Object-Relational Behavioral Patterns
- [Unit of Work](#unit-of-work) — p. 184
- [Identity Map](#identity-map) — p. 195
- [Lazy Load](#lazy-load) — p. 200

### Chapter 12 — Object-Relational Structural Patterns
- [Identity Field](#identity-field) — p. 216
- [Foreign Key Mapping](#foreign-key-mapping) — p. 236
- [Association Table Mapping](#association-table-mapping) — p. 248
- [Dependent Mapping](#dependent-mapping) — p. 262
- [Embedded Value](#embedded-value) — p. 268
- [Serialized LOB](#serialized-lob) — p. 272
- [Single Table Inheritance](#single-table-inheritance) — p. 278
- [Class Table Inheritance](#class-table-inheritance) — p. 285
- [Concrete Table Inheritance](#concrete-table-inheritance) — p. 293
- [Inheritance Mappers](#inheritance-mappers) — p. 302

### Chapter 13 — Object-Relational Metadata Mapping Patterns
- [Metadata Mapping](#metadata-mapping) — p. 306
- [Query Object](#query-object) — p. 316
- [Repository](#repository) — p. 322

### Chapter 14 — Web Presentation Patterns
- [Model View Controller](#model-view-controller) — p. 330
- [Page Controller](#page-controller) — p. 333
- [Front Controller](#front-controller) — p. 344
- [Template View](#template-view) — p. 350
- [Transform View](#transform-view) — p. 361
- [Two Step View](#two-step-view) — p. 365
- [Application Controller](#application-controller) — p. 379

### Chapter 15 — Distribution Patterns
- [Remote Facade](#remote-facade) — p. 388
- [Data Transfer Object](#data-transfer-object) — p. 401

### Chapter 16 — Offline Concurrency Patterns
- [Optimistic Offline Lock](#optimistic-offline-lock) — p. 416
- [Pessimistic Offline Lock](#pessimistic-offline-lock) — p. 426
- [Coarse-Grained Lock](#coarse-grained-lock) — p. 438
- [Implicit Lock](#implicit-lock) — p. 449

### Chapter 17 — Session State Patterns
- [Client Session State](#client-session-state) — p. 456
- [Server Session State](#server-session-state) — p. 458
- [Database Session State](#database-session-state) — p. 462

### Chapter 18 — Base Patterns
- [Gateway](#gateway) — p. 466
- [Mapper](#mapper) — p. 473
- [Layer Supertype](#layer-supertype) — p. 475
- [Separated Interface](#separated-interface) — p. 476
- [Registry](#registry) — p. 480
- [Value Object](#value-object) — p. 486
- [Money](#money) — p. 488
- [Special Case](#special-case) — p. 496
- [Plugin](#plugin) — p. 499
- [Service Stub](#service-stub) — p. 504
- [Record Set](#record-set) — p. 508

---

## Entry Format (reference)

Each entry uses this structure — do not deviate:

```
## [Pattern Name]
> Source: Chapter X — Book p.XXX (Fowler, PEAA 2002)

**Category**: [chapter category]
**Intent** *(from book, p.XXX)*: "[exact or close paraphrase]"
...
- [condition favoring an alternative]

### Competing Patterns
- Prefer [X] when [condition] — p.XXX

### Code Signature (Python)
*(adapted from book's Java/C# example, p.XXX)*
\```python
# structural shape — not a complete implementation
\```
...
Signs this pattern is missing or broken:
- [observable code symptom]
```
