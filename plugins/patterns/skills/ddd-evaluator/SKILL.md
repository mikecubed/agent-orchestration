...
| **Repositories** | Collection-like interface? Returns domain objects (not DTOs/rows)? |
| **Services** | Stateless? Named as verb? Doesn't duplicate Entity behavior? |
| **Ubiquitous Language** | Do class/method names match domain terms? Or are they technical? |
| **Layer isolation** | Is domain layer free of infrastructure imports? |
